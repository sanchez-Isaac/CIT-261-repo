...
xhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById("geoAPI").innerHTML =  '<a target="_blank" href=' +coordinates+jsonObj.coord.lat +'°,'+jsonObj.coord.lon +'°'+ '>Google Maps</a>'  ;   
...
document.getElementById("tableid").className = "tableclass";

document.getElementById("map").className = "googlemapClass";
